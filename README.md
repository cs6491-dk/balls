 ...
 * Design an interface where as the mouse is pressed, it generates one new ball per frame. Explore alternatives where several balls are generated (in some cone of directions) of where several balls are placed in nearby corners.
